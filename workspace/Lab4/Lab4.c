...
float xk_3 = 0;
float xk_4 = 0;
float yk = 0; //yk is the filtered value
...
void main(void)
{
    ...
    {
        if (UARTPrint == 1 ) {
            serial_printf(&SerialA,"ADCINDO Voltage:%d ADCIND1 Voltage: %d\r\n",adcd0result, adcd1result);
            UARTPrint = 0;
        }
    }
...
__interrupt void ADCD_ISR(void)
{
    ...
    volt_adcd1 = adcd1result*(3.0/4096.0); // Here covert ADCIND0 to volts
